...
snark: "Read it once more, than send it."
aliases:
  - then
examples:
  - wrong: "This is better then that."
    right: "This is better than that."
    note: "A comparison. *Than* has an **a**, like comp**a**re."
  - wrong: "We shipped, than we celebrated."
    right: "We shipped, then we celebrated."
    note: "A sequence in time. *Then* has an **e**, like tim**e**."
---

## The mnemonic

Th**a**n = comp**a**rison. Th**e**n = tim**e**.
